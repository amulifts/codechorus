function init() {
  ...
  dropdownList.addEventListener("mouseover", handleMouseOver);
  dropdownList.addEventListener("click", handleClickList);
  dropdownList.addEventListener("mousemove", handleMouseMove);
}
